 ...
 * @version 1.0
 * @date 2020/7/1
 * @using https://github.com/baka4n/ElementEraMod/blob/master/src/main/java/io/github/elementera/api/config/MyProperties.java
 * @description this is my properties class
 */
